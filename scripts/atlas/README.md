...
The structures in the ESM Metagenomic Atlas were predicted with `fair_esm.pretrained.esmfold_v0()` for Atlas `v0`, while Atlas `v2023_02` used `fair_esm.pretrained.esmfold_v1()`.
...
- `esmfold_version` is the version of ESMFold, matching the model accessible as `fair_esm.pretrained.esmfold_v{0,1}`
